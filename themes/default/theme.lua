...
-- theme.wallpaper = awful.util.getdir("config") .. "themes/default/qt_desktop_background_01.png"
theme.wallpaper = awful.util.getdir("config") .. "themes/default/black_background_lines_scratches_69440_1920x1080.jpg"
